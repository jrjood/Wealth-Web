                  ...
                  <Link to={`/projects/${project.id}`}>
                    <div className='relative overflow-hidden rounded-sm card-elevated'>
                      ...
                      <div className='absolute top-4 left-4'>
                        <span className='px-3 py-1 bg-primary text-primary-foreground text-xs font-semibold tracking-wide rounded-sm'>
                          {project.status}
                        </span>
                      </div>
                      ...
                      <div className='absolute top-4 right-4'>
                        <span className='px-3 py-1 bg-secondary text-secondary-foreground text-xs font-semibold tracking-wide rounded-sm'>
                          {project.type}
                        </span>
                      </div>
                    </div>
