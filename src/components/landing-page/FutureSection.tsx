...
const stats = [
  { label: 'Years of Experience', suffix: '+', value: 10 },
  { label: 'Projects Delivered', suffix: '+', value: 8 },
  { label: 'EGP Portfolio Value', suffix: 'B+', value: 10 },
  { label: 'Happy Clients', suffix: '+', value: 1000 },
];
...
const FutureSection = () => {
  ...
  return (
    <section
      ...
      ref={sectionRef}
      data-scroll
      data-scroll-speed={isMobile ? '0' : '-3'}
