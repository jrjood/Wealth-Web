...
const OverlayScrollbar = () => {
  const [thumb, setThumb] = useState<ScrollThumbState>({ height: 0, offset: 0 });
  ...
  return (
    <div
      aria-hidden='true'
      className={cn(
        'pointer-events-auto fixed right-[6px] top-3 z-[10000] h-[calc(100vh-24px)] w-4 transition-opacity duration-200',
